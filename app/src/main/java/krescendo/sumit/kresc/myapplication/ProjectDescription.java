...
public class ProjectDescription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            web.loadUrl(new JsonBilder().getHostName()+"krishna/project/"+str.toString().trim());
            web.setWebChromeClient(new WebChromeClient() {
            ...
            web.setWebViewClient(new WebViewClient() {
                ...
                public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                    ...
                    Toast.makeText(ProjectDescription.this," Check Internet Connectivity . ",Toast.LENGTH_LONG).show();
                }
            });
